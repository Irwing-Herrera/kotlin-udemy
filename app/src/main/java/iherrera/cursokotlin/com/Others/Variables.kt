package iherrera.cursokotlin.com.Others

import android.util.Log

/*
    No hay tipos basicos y no existe void. Si algno no devuelve nada, esta devolviendo < Unit >.
    Las variables pueden ser mutables o inmutables, < var , val >
*/
